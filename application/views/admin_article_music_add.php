                    ...
                    <form action="" method="post" class="form" enctype="multipart/form-data">
                        ...
                        <section class="content">
                            ...
                            <div class="box-body">
                                ...
                                <div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="art_likes" name="art_likes" required
                                                   tabindex="1"
                                                   value="<?= $art_likes; ?>"
                                                   placeholder="Nhập số lượt like">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label>Nhạc</label>
                                    <input type="text" class="form-control" id="art_musics" name="art_musics"
                                           value="<?= $art_music; ?>" placeholder="Upload Nhạc">
                                    <div class="form-group">
                                        <input type="file" name="fileMusic">
                                    </div>
                                    <label>Hình ảnh</label>
                                    <input type="text" class="form-control" id="art_images" name="art_images"
                                           value="<?= $art_images; ?>" placeholder="Upload ảnh">
                                    <div class="form-group">
...
<!--                                <p><b>ID video</b>: <font color="red"><b>4buvABCZr8M</b></font></p>-->
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" name="art_check_1"
                                           id="art_check_1"<? if ($art_check_1 == 'on') echo 'checked="checked"';
                                    echo ''; ?>>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" name="art_check_2"
                                           id="art_check_2"<? if ($art_check_2 == 'on') echo 'checked="checked"';
                                    echo ''; ?>>
                                </div>
                            </div>
                            <!-- /.box-body -->
