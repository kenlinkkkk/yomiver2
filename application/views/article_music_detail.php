                ...
                <div class="row nopadding">
                    <div class="col-md-12 nopadding ">
                        <p class="" style="padding: 10px 10px 0px 0px;color: #fff;font-weight: bold;margin-bottom: 0px">
                            <font
                                    size="5"><strong><?= $title; ?></strong></font></p>
                    </div>
                                ...
                                <div class="row col-md-12 col-xs-12 nopadding" style="margin-top: 10px;">
                                    ...
                                    <div class="col-md-6 col-xs-6 nopadding">
                                        <div class="videolq"><p><a
                                                        href="<?= base_url() . 'nhac/' . $row->article_url; ?>"><img
                                                            src="<?= $row->images; ?>"></a></p></div>
                                    </div>
                                    <div class="col-md-6 col-xs-6 nopadding">
                                        <div class="tenlq" style="padding-left: 10px;">
                                            <p class="chu5"><a href="<?= base_url() . 'nhac/' . $row->article_url; ?>"><font
                                                            color="#fff"
                            ...
                            <? foreach ($data_videos_recommend->result() as $row) { ?>
                                <div class="item">
                                    <a href="<?= base_url() . 'nhac/' . $row->article_url; ?>" class="thumbnail"> <img
                                                ...
                                                alt="<?= $row->title; ?>"></a>
                                    <div class="mota1">
                                        <p class="mota2 line-clamp module" style="color: white;"><a href="<?= base_url() . 'nhac/' . $row->article_url; ?>"><font
