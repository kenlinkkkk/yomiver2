                ...
                <div class="row nopadding">
                    <div class="col-md-12 nopadding ">
                        <p class="" style="padding: 10px 10px 0px 0px;color: #fff;font-weight: bold;margin-bottom: 0px">
                            <font size="5"><strong><?= $title; ?></strong></font></p>
                    </div>
                ...
                <div class="col-sm-8 nopadding">
                    <div class="xem panel panel-default ">
                        <div class="panel-body" align="center">
                            <video width="100%" style="max-height: 400px" controls autoplay>
    ...
    margin-left: 10px; color: white"
                                ...
                                <div class="row col-md-12 col-xs-12 nopadding" style="margin-top: 10px;">
                                    ...
                                    <div class="col-md-6 col-xs-6 nopadding">
                                        <div class="tenlq" style="padding-left: 10px;">
                                            <p class="chu5"><a href="<?= base_url() . 'video/' . $row->article_url; ?>"><font
                                                            color="#fff"
            ...
            <div class="col-sm-12 nopadding">
                <div class="col-xs-12 colreponse nopadding">
                    <div class="col-sm-12 nopadding colreponse">
                        <div class="col-sm-3 col-xs-9 nopadding">
                            <p class="tieude">VIDEO ĐỀ XUẤT</p>
                        </div>
...
">
                    ...
                    <div class="col-sm-12 col-xs-12 nopadding">
                        <div class="owl-carousel owl-theme">
                            <? foreach ($data_videos_recommend->result() as $row) { ?>
                                <div class="item">
                                    <a href="<?= base_url() . 'video/' . $row->article_url; ?>" class="thumbnail"> <img
                                                src="<?= $row->images; ?>"
                                                alt="<?= $row->title; ?>"></a>
                                    <div class="mota1">
                                        <p class="mota2 line-clamp module" style="color: white;"><a href="<?= base_url() . 'video/' . $row->article_url; ?>"><font
                    ...
                    <div class="col-sm-12 col-xs-12 nopadding">
                        <div class="owl-carousel owl-theme">
                            <? foreach ($data_videos_recommend1->result() as $row) { ?>
                                <div class="item">
                                    <a href="<?= base_url() . 'video/' . $row->article_url; ?>" class="thumbnail"> <img
                                                src="<?= $row->images; ?>"
                                                alt="<?= $row->title; ?>"></a>
