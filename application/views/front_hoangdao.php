                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-5">
                            <div class="card" style="background-color: rgba(0,0,0,0)">
                                <div class="card-header text-center">
                                    <hr>
                                    <img src="<?= base_url()?>/images/stickers/horo1.png" class="vh-center img-fit">
                                    <hr>
                                </div>
                        ...
                        <div class="col-sm-12 col-md-5">
                            <div class="card" style="background-color: rgba(0,0,0,0)">
                                <div class="card-header text-center">
                                    <hr>
                                    <img src="<?= base_url()?>/images/stickers/horo2.png" class="vh-center img-fit">
                                    <hr>
                                </div>
                                <div class="card-body text-center">
                                    <hr class="width-hr">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-5">
                            <div class="card" style="background-color: rgba(0,0,0,0)">
                                <div class="card-header text-center">
                                    <hr>
                                    <img src="<?= base_url()?>/images/stickers/horo3.png" class="vh-center img-fit">
                                    <hr>
                                </div>
                                <div class="card-body text-center">
                                    <hr class="width-hr">
